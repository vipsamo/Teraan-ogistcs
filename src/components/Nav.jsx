              ...
              <div className="flex h-9 items-center justify-between">
                ...
                <div className="flex ">
                  ...
                  >
                    ...
                    <XMarkIcon className="h-6 w-6 text-indigo-600  " aria-hidden="true" />
                  </button>
                </div>
              </div>
                  ...
                  <div className="space-y-2 py-6">
                    {navigation.map((item) => (
                      <a
                        key={item.id}
                        href={item.path}
                        className="-mx-3 block bg-zinc-200 border-b-2 border-zinc-300 text-center rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-600 hover:bg-gray-400/10"
                      >
                        {item.title}
                      </a>
                    ))}
