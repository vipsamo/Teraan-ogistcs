...
const Team = () => {
  return (
    <div>
     <h1 className='text-2xl font-semibold leading-8 text-indigo-600 py-20'>OUR TEAM</h1>
     <div className=' grid md:grid-cols-3 sm:grid-cols-1 gap-2 py-4 mt-4 h-full w-full '>
